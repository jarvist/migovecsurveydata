...
parser = argparse.ArgumentParser(description='Convert plan survey svg into pdfs and pngs.')
...
call(["inkscape", "-z", "-b=#FFFFFF", "-d=300", SVG_FILE, "-e="+YEAR+"SistemMigovec-Plan-ENG.png"])
call(["inkscape", "-z", "-b=#FFFFFF", "-d=300", SVG_FILE, "-A="+YEAR+"SistemMigovec-Plan-ENG.pdf"])
...
if slo is not None:
    ...
    call(["inkscape", "-z", "-b=#FFFFFF", "-d=300", SVG_FILE, "-e="+YEAR+"SistemMigovec-Plan-SLO.png"])
    call(["inkscape", "-z", "-b=#FFFFFF", "-d=300", SVG_FILE, "-A="+YEAR+"SistemMigovec-Plan-SLO.pdf"])
